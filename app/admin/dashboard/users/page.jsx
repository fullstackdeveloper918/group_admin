     ...
     <div className='grid grid-cols-3 gap-4'>
        {
          data.result && data.result.map((item,index)=>(
            ...
            {/* </div>  */}
             ...
             <h1 className='text-center text-lg text-black'>{item.full_name} Cards</h1>
